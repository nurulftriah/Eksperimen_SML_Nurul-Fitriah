...
if dagshub_owner and dagshub_repo and dagshub_token:
    ...
    print("No DagsHub credentials found. Using local tracking URI.")
...
def main():
    ...
    with mlflow.start_run() as run:
        ...
        # c. confusion_matrix.png
        cm = confusion_matrix(y_test, y_pred)
        disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=["Lancar", "Gagal Bayar"])
